...
use crate::{
    ...
    settings::{
        ...
        DEFAULT_AUDIO_QUALITY, DEFAULT_AUDIO_SAMPLE_RATE, DEFAULT_FPS, DEFAULT_GIF_COLORS,
        DEFAULT_GIF_DITHER, DEFAULT_PIXEL_FORMAT, DEFAULT_PRESET, DEFAULT_RESOLUTION,
        DEFAULT_SCALING_ALGORITHM, DEFAULT_VIDEO_BITRATE, DEFAULT_VIDEO_BITRATE_MODE,
        DEFAULT_VIDEO_CODEC, DeinterlaceMode as GpuiDeinterlaceMode,
...
pub fn core_config_from_gpui(config: &GpuiConversionConfig) -> CoreConversionConfig {
    CoreConversionConfig {
        ...
        audio_sample_rate: non_empty_or(&config.audio_sample_rate, DEFAULT_AUDIO_SAMPLE_RATE),
